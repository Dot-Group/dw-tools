 ...
 *     </tr>
 *     <tr>
 *         <td>renderQuotedNames</td>
 *         <td>EXPLICIT_DEFAULT_QUOTED</td>
 *         <td>
 *             Whether rendered schema, table, column, etc. names should be quoted in rendered SQL,
 *             or transformed in any way.  Valid values are ALWAYS,EXPLICIT_DEFAULT_QUOTED,EXPLICIT_DEFAULT_UNQUOTED,NEVER;.
 *         </td>
 *     </tr>
 *     <tr>
 *         <td>renderNameCase</td>
 *         <td>UPPER</td>
...
public class JooqFactory {
    ...
    @NotNull
    private RenderQuotedNames renderQuotedNames = RenderQuotedNames.EXPLICIT_DEFAULT_QUOTED;

    @NotNull
    private RenderNameCase renderNameCase = RenderNameCase.UPPER;
    ...
    private Settings buildSettings() {
        ...
        settings.setRenderQuotedNames(renderQuotedNames);
        settings.setRenderNameCase(renderNameCase);
