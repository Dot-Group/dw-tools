...
import ai.dot.dwtools.jooq.jersey.JooqBinder;
...
public class JooqBundleTest {
    ...
    private final String validationQueryPrimary = "this is a query for primary";
    private final String validationQueryReplica = "this is a query for replica";

    private JooqBundle<DropwizardConfig> jooqBundle = new JooqBundle<>() {
		@Override
    ...
    private final JooqBundle<DropwizardConfig> jooqBundleMultiDS = new JooqBundle<>() {
		@Override
		public JooqFactory getJooqFactory(DropwizardConfig configuration) {
			return jooqFactory;
		}
    ...
    public void setup() throws Exception {
        ...
        when(dataSourceFactoryPrimary.getValidationQuery()).thenReturn(Optional.of(validationQueryPrimary));
        when(dataSourceFactoryReplica.getValidationQuery()).thenReturn(Optional.of(validationQueryReplica));
    }
